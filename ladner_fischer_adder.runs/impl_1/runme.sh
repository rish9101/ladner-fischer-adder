...
HD_PWD='C:/Users/HP_OWNER/Desktop/project/ladner_fischer_adder/ladner_fischer_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_prog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_prog.tcl -notrace
