...
HD_PWD='C:/Users/HP_OWNER/Desktop/project/ladner_fischer_adder/ladner_fischer_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_prog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_prog.tcl
